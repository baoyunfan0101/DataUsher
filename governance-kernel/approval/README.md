...
- Express ordering through acyclic step dependencies; independent steps may be active in parallel.
- Retire a template version to block new submissions without changing existing request snapshots.
