...
public record WorkflowInstanceStateChangedEvent(
        String eventId,
        Instant occurredAt,
        RequestContext requestContext,
        WorkflowInstanceState previousState,
        WorkflowInstance workflowInstance
) implements DomainEvent {
    public WorkflowInstanceStateChangedEvent {
        ...
        if (previousState == workflowInstance.state()) {
            throw new IllegalArgumentException("workflow instance state must change");
        }
    }

    @Override
    public String eventType() {
        return WorkflowEvents.INSTANCE_STATE_CHANGED;
    }
